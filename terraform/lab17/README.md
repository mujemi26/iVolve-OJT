<h1>Multi-Tier Application Deployment with Terraform</h1>
...
> ## 1. First we will start with the main.tf file

```
# This Terraform configuration creates a multi-tier AWS
...
> ## 2. The Outputs.tf file is a file which defines the terraform outputs after applying the configuration
...
```
# To apply and test this Terraform configuration:
